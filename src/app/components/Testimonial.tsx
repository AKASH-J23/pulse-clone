          ...
          <div className="grid grid-cols-6 md:grid-cols-8 lg:grid-cols-12">
            ...
            <div className="col-span-full md:col-start-4 lg:col-start-5 md:col-span-8 text-white z-10">
              <div className="text-3xl md:text-5xl font-heading font-bold pt-10 md:pt-0">
                <p>
                  From the outset, Nuvanta Consult demonstrated their expertise and commitment by providing us with an experienced team led by a Director who played an integral role in supporting the delivery of Kennington Lane. Their support during the due diligence phase was invaluable, ensuring that every aspect was meticulously reviewed and assessed. Guidance through the negotiation of the Development and Funding agreement was instrumental in securing agreeable terms and protecting our interests. The professionalism and dedication shown by Nuvanta Consult team has been exceptional. Their deep understanding of project and cost management, combined with their proactive approach, has significantly contributed to the successful progress of the Kennington Lane scheme. We look forward to continuing our partnership with Nuvanta Consult on future projects.
                </p>
              </div>
