...
const ServicesList = () => (
  <section className="overflow-hidden pb-14 md:pb-20 lg:pb-24" data-block="blockPagesList">
    <div className="relative bg-pink-100">
      <div className="container pt-16 lg:pt-20 xl:pt-28 pb-16 lg:pb-20">
        <div className="reveal">
          <div className="grid grid-cols-12">
            <div className="col-span-full sm:col-start-3 sm:col-span-10 md:col-start-5 md:col-span-7 z-10">
              <p className="mb-0 pb-5 relative font-bold after:absolute after:w-full after:bg-[#BAD1F0] after:h-[1px] after:bottom-0 after:left-0">Services</p>
              {services.map((service) => (
                ...
                >
                  ...
                  <p className="text-3xl sm:text-6xl font-bold max-w-[650px] font-heading pl-9">
                    {service.title}
                  </p>
                  <svg className="shrink-0 w-8 h-8 md:h-10" width="43" height="41" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43 41"><path fill="currentColor" d="M8.85.721v3h28.756L.68 38.454l2.056 2.186L39.85 5.729V35.72h3v-35h-34Z"/></svg>
                </a>
              ))}
            </div>
          </div>
